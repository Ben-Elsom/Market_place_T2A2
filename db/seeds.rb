...
question3 = Question.create(title:"What is your best pick up line", prize: 10, response_cost: 0.10, closing_date_and_time: date3)
...
question5 = Question.create(title:"What is your best piece of advice", description: "feeling bored and have got $20 burning a hole in my pocket. What's your best piece of life advice?", prize: 100, response_cost: 10.10, closing_date_and_time: date5)
...
question6 = Question.create(title:"What should I name my child?", description: "My husband and I have just found out we are expecting a baby in August of this year. What are you best name suggestions?", prize: 50, response_cost: 5.0, closing_date_and_time: date6)
